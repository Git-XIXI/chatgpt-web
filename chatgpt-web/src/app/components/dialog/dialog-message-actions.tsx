...
import {GlmModel} from '../../constants'
...
export default function DialogMessagesActions(props: {
    ...
    return <div className={styles['chat-input-actions']}>
        <Select
            value={config?.glmModel ?? GlmModel.GLM_3_5_TURBO}
            style={{width: 160}}
            options={[
                {value: GlmModel.GLM_3_5_TURBO, label: 'GLM_3_5_TURBO'},
                {value: GlmModel.CHATGLM_PRO, label: 'CHATGLM_PRO'},
                {value: GlmModel.CHATGLM_LITE, label: 'CHATGLM_LITE'},
                {value: GlmModel.CHATGLM_LITE_32K, label: 'CHATGLM_LITE_32K'},
                {value: GlmModel.CHATGLM_STD, label: 'CHATGLM_STD'},
                {value: GlmModel.CHATGLM_TURBO, label: 'CHATGLM_TURBO'},
            ]}
            onChange={(value) => {
